...
<form action="<?php the_permalink(); ?>" method="post" class="contact-form">
    <fieldset>
        ...
        <div class="field">
            <label for="from">
                <?php _e( 'Name', $text_domain_string ); ?> <small class="help-inline"><?php _e( '*', $text_domain_string ); ?></small>
            </label>
        ...
        <div class="field">
            <label for="email">
                <?php _e( 'E-mail address', $text_domain_string ); ?> <small class="help-inline"><?php _e( '*', $text_domain_string ); ?></small>
            </label>
        ...
        <div class="field">
            <label for="subject">
                <?php _e( 'Subject', $text_domain_string ); ?> <small class="help-inline"><?php _e( '*', $text_domain_string ); ?></small>
            </label>
        ...
        <div class="field">
            <label for="text">
                <?php _e( 'Message', $text_domain_string ); ?> <small class="help-inline"><?php _e( '*', $text_domain_string ); ?></small>
            </label>
        ...
        <p class="form-submit">
            <input class="submit" type="submit" name="submit" value="<?php esc_attr_e( 'Submit &rarr;', $text_domain_string ); ?>" />
        </p>
